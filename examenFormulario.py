...
class VentanaPrincipal(QMainWindow):
    def __init__(self):
        ...
        1) VER LOS EVENTOS DE TODOS LOS CODIGOS
        - FIJARME QUE OBJETO ME DEVUELVE CADA CLASE!!
        - class Persona(QPersona) -> HEREDA DE QPERSONA, POR LO QUE ME DEVUELVE UNA PERSONA!! NO ES QUE ESTE RECIBIENDO DE PARAMETRO UNA PERSONA!! POR LO QUE TENDRA FUNCIONES HEREDADAS
        - BUSCAR MAS PROPIEDADES EXTRAS EN LAYOUTS, COMO AGRANDAR... ETC PARA FACILITARLO
        2) PENSAR EN EVENTOS QUE PUEDE PONER EL PROFE Y HACERLOS YO
        3) HACER LOS EVENTOS QUE PUSO EL PROFE EN FORMULARIO
        4) SABER BUSCAR EN INTERNET FUNCION/PROPIEDAD Y SABER INTERPRETARLA
        5) PONER BIEN LOS READMES. SEPARARLOS BIEN POR FUNCIONES, COSAS QUE HACEN...
